...
INSTALLED_APPS = [
    ...
    # Shared utilities (template tags, base models)
    'common',
...
#
# Configuration:
# - Development (no DATABASE_URL): Uses SQLite for simplicity
# - Production (DATABASE_URL set): Uses PostgreSQL from the URL
...
# Media (uploads). For MVP we use URL images, but keep this ready.
MEDIA_URL = "media/"
MEDIA_ROOT = BASE_DIR / "media"

# Auth UX defaults (avoid /accounts/profile/ 404 after login)
